    ...
    <main>
      ...
      <div className="flex-grow">
        ...
        <section id="about" className="py-20 px-6 overflow-hidden relative">
          {/* Éléments d'arrière-plan animés - PERMANENTS ET SPECTACULAIRES */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            {/* Lignes de force tournantes */}
            <motion.div
              className="absolute inset-0"
              style={{
                background: 'conic-gradient(from 0deg, transparent, #A2CA6C20, transparent, #24453920, transparent)',
              }}
              animate={{
                rotate: [0, 360],
              }}
            ...
            {/* Vagues lumineuses perpétuelles */}
            <svg className="absolute inset-0 w-full h-full">
              <defs>
                <linearGradient id="wave-glow" x1="0%" y1="0%" x2="100%" y2="0%">
                  ...
                  <stop offset="50%" stopColor="#A2CA6C" stopOpacity="0.2">
                    <animate
                      attributeName="stop-opacity"
                      values="0.2;0.5;0.2"
                      dur="4s"
              ...
              {[...Array(5)].map((_, i) => (
                <motion.path
                  key={i}
                  d={`M 0 ${400 + i * 80} C 300 ${300 + i * 60} 600 ${500 + i * 40} 900 ${350 + i * 70} T 1800 ${400 + i * 80}`}
            ...
            {/* Particules statiques mais animées en permanence */}
            <div className="absolute inset-0">
              {Array.from({ length: 8 }).map((_, row) => (
                Array.from({ length: 8 }).map((_, col) => {
                  const x = 5 + col * 12;
                  const y = 5 + row * 12;
                  const delay = (row * 8 + col) * 0.1;
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        left: `${x}%`,
                        top: `${y}%`,
                        background: row % 2 === 0 ? '#A2CA6C' : '#244539',
            ...
            {[...Array(4)].map((_, i) => (
              <motion.div
                ...
                style={{
                  borderColor: i % 2 === 0 ? '#A2CA6C30' : '#24453930',
                  left: '50%',
                  top: '50%',
                  width: `${200 + i * 150}px`,
                  height: `${200 + i * 150}px`,
            ...
            {[...Array(12)].map((_, i) => (
              <motion.div
                ...
                style={{
                  background: `linear-gradient(90deg, transparent, ${i % 2 === 0 ? '#A2CA6C' : '#244539'}40, transparent)`,
                  left: '50%',
                  top: '50%',
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            {/* Titre avec animation spectaculaire - ENTRÉE CINÉMATIQUE */}
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              ...
              >
                <motion.span
                  className="absolute -inset-10 bg-gradient-to-r from-[#A2CA6C]/0 via-[#A2CA6C]/20 to-[#A2CA6C]/0 blur-3xl"
                  animate={{
                    x: ['-100%', '200%'],
                  }}
                  transition={{
                ...
                {/* Double ligne animée */}
                <motion.div
                  className="absolute -bottom-6 left-0 h-0.5"
                  style={{
                    background: 'linear-gradient(90deg, transparent, #A2CA6C, #244539, #A2CA6C, transparent)',
                    width: '100%',
                  }}
                ...
                <motion.div
                  className="absolute -bottom-8 left-1/4 h-0.5 w-1/2"
                  style={{
                    background: 'linear-gradient(90deg, transparent, #A2CA6C80, transparent)',
                  }}
                  animate={{
                    scaleX: [0, 1, 0],
                    opacity: [0, 0.5, 0],
              ...
              {/* Sous-titre avec animation de vague */}
              <motion.div
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              {/* Texte avec apparition par mots - ENTRÉE CINÉMATIQUE */}
              <motion.div
                initial={{ opacity: 0, x: -100 }}
              ...
              >
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <motion.p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6 text-lg">
                    {["As", "a", "passionate", "freelance", "Fullstack", "developer,", "I", "design", "modern,", 
                      "robust,", "and", "scalable", "web", "applications.", "My", "goal", "is", "to", "transform", 
                      "ideas", "into", "high-performing", "and", "intuitive", "digital", "products."].map((word, i) => (
                      <motion.span
                        key={i}
                        variants={{
                          hidden: { 
                ...
                {/* Indicateur d'expertise avec animation permanente */}
                <motion.div 
                ...
                >
                  <motion.div 
                    className="w-12 h-12 rounded-full border-2 border-[#A2CA6C] dark:border-[#21D375] flex items-center justify-center"
                    animate={{ 
                      scale: [1, 1.1, 1],
                      rotate: [0, 360],
                      borderColor: ['#A2CA6C', '#244539', '#A2CA6C']
                    }}
                    transition={{ 
                      duration: 4,
                      repeat: Infinity,
                  ...
                  >
                    <motion.div 
                      className="w-2 h-2 bg-[#A2CA6C] dark:bg-[#21D375] rounded-full"
                      animate={{ 
                        scale: [1, 1.8, 1],
                        opacity: [1, 0.5, 1]
                      }}
                  ...
                  <motion.span 
                    className="text-sm text-[#A2CA6C] dark:text-[#21D375] font-medium"
                    animate={{
                      x: [0, 5, 0],
                      opacity: [0.7, 1, 0.7]
                    }}
              ...
              {/* Blocs valeurs avec animations en cascade - ENTRÉE 3D PERMANENTE */}
              <motion.div 
              ...
              >
                ...
                <motion.div
                  ...
                  whileHover={{ 
                    scale: 1.05,
                    rotateY: 8,
                    boxShadow: "0 30px 50px rgba(162, 202, 108, 0.3)",
                    transition: { type: "spring", stiffness: 300 }
                  }}
                  className="p-6 rounded-xl bg-gradient-to-br from-[#A2CA6C] to-[#8BB55C] dark:from-[#244539] dark:to-[#1A3329] shadow-md hover:shadow-xl transition-all duration-300 group cursor-pointer transform-gpu"
                >
                  <div className="flex items-start gap-4">
                    ...
                    >
                      <Cpu size={32} className="text-black dark:text-white group-hover:scale-110 transition-transform duration-300" />
                    </motion.div>
                    
                    <div>
                      <motion.h3 
                        className="flex items-center gap-2 text-xl font-semibold mb-2 text-black dark:text-white"
                        animate={{
                          x: [0, 3, 0]
                        }}
                        transition={{
                  ...
                  {/* Barre de progression animée en permanence */}
                  <motion.div
                ...
                >
                  <div className="flex items-start gap-4">
                    <motion.div
                      ...
                      className="p-3 bg-white/20 rounded-xl"
                    >
                      <IconGauge size={32} stroke={1.5} className="text-black dark:text-white group-hover:scale-110 transition-transform duration-300" />
                    </motion.div>
                  ...
                  {/* Indicateur de vitesse animé en permanence */}
                  <motion.div
                ...
                >
                  <div className="flex items-start gap-4">
                    <motion.div
                      ...
                      className="p-3 bg-white/20 rounded-xl"
                    >
                      <Handshake size={32} weight="duotone" className="text-black dark:text-white group-hover:scale-110 transition-transform duration-300" />
                    </motion.div>
                  ...
                  {/* Indicateur de collaboration animé en permanence */}
                  <motion.div
            ...
            {/* Bouton d'action avec animation permanente */}
            <motion.div
            ...
            >
              <motion.a
                href="#contact"
                className="inline-flex items-center gap-3 px-10 py-4 bg-[#A2CA6C] dark:bg-[#244539] text-white font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                ...
                <motion.span
                  ...
                  style={{
                    background: 'radial-gradient(circle, #A2CA6C80 0%, transparent 70%)',
                  }}
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0, 0.3, 0],
